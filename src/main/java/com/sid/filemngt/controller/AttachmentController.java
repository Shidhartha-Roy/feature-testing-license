...
public class AttachmentController {
    ...
    @PostMapping("/upload")
    public ResponseDataModel uploadFile(@RequestParam("file")MultipartFile file) throws Exception {
        ...
        return new ResponseDataModel(attachment.getFileName(),downloadURL,file.getContentType(), file.getSize());
    }
